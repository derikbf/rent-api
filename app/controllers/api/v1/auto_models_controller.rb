module Api
    ...
    class AutoModelsController < ApplicationController
      ...
      # GET /auto_models
      def index
        @auto_models = AutoModel.order("created_at DESC").page(params[:page].try(:[], :number))
      ...
      def create
        ...
        if @auto_model.save
          ...
          render json: ErrorSerializer.serialize(@auto_model.errors), status: :unprocessable_entity 
        end
      end
